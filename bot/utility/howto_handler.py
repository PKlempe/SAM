...
def code():
    ...
    embed.add_field(
        ...
        value="Auf der [Discord Support Seite](https://support.discord.com/hc/en-us/articles/210298617-Markdown-Text-101-Chat-Formatting-Bold-Italic-Underline-) gibt es mehr Infos zu Discords Markdownsyntax"
    )
    return embed
